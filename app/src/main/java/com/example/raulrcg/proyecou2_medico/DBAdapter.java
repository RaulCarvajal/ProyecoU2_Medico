...
public class DBAdapter {
    ...
    //Insertar paciente
    public boolean insertPaciente(String name, String address, String email) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(NAME_P, name);
        initialValues.put(ADDRESS_P, address);
        initialValues.put(EMAIL_P, email);
        initialValues.put(DATE_P, Calendar.getInstance().getTime().toGMTString());
    ...
    public Cursor getMedicamento(int id) {
        Cursor mCursor=db.query(true, DATABASE_TABLE_M,
                new String[] {NAME_M,PADECIMIENTO_M,INSTRUCCIONES_M,DATE_CONS_M,
    ...
    //update paciente
    public boolean updatePaciente(long rowId, String name, String address, String email,String dt) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(NAME_P, name);
        initialValues.put(ADDRESS_P, address);
        initialValues.put(EMAIL_P, email);
